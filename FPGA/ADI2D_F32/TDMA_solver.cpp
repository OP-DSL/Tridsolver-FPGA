...
static void thomas_interleave(hls::stream<uint256_dt> &d_stm, hls::stream<uint256_dt> &d_fw_stm,
		ap_uint<12> d0, ap_uint<16> B, int ReadLimit){
...
static void TDMA1( const uint512_dt* d, uint512_dt* u,
	...
	thomas_interleave(d_stm_0[3], d_fw_stm[0], M, B_X, ReadLimit_X);
	thomas_forward(d_fw_stm[0], c2_fw_stm[0], d2_fw_stm[0], M, B_X);
...
//	TDMA_comp(d_stm_0[3], u_stm_0[0], M, N, B, 0);
	...
	thomas_interleave(d_stm_0[4], d_fw_stm[1], N, B_Y, ReadLimit_Y);
	thomas_forward(d_fw_stm[1], c2_fw_stm[1], d2_fw_stm[1], N, B_Y);
	thomas_backward(c2_fw_stm[1], d2_fw_stm[1], u_stm_0[3], N, B_Y, ReadLimit_Y);
//	TDMA_comp(d_stm_0[4], u_stm_0[3], M, N, B, 1);
	...
	thomas_interleave(d_stm_1[3], d_fw_stm[2], M, B_X, ReadLimit_X);
	thomas_forward(d_fw_stm[2], c2_fw_stm[2], d2_fw_stm[2], M, B_X);
	thomas_backward(c2_fw_stm[2], d2_fw_stm[2], u_stm_1[0], M, B_X, ReadLimit_X);
//	TDMA_comp(d_stm_1[3], u_stm_1[0], M, N, B, 0);
	...
	thomas_interleave(d_stm_1[4], d_fw_stm[3], N, B_Y, ReadLimit_Y);
	thomas_forward(d_fw_stm[3], c2_fw_stm[3], d2_fw_stm[3], N, B_Y);
	thomas_backward(c2_fw_stm[3], d2_fw_stm[3], u_stm_1[3], N, B_Y, ReadLimit_Y);
//	TDMA_comp(d_stm_1[4], u_stm_1[3], M, N, B, 1);
	interleaved_col_row(u_stm_1[3], u_stm_1[4], M, N, B, 1);

	// iteration three

	process_grid(u_stm_1[4], d_stm_2[1], acc_stm[4], acc_stm[5], data_g, 0);

	interleaved_row_block8(d_stm_2[1], d_stm_2[2], M, N, B, 0);
	stream_8x8transpose(d_stm_2[2], d_stm_2[3], M, N, B, 0);

	thomas_interleave(d_stm_2[3], d_fw_stm[4], M, B_X, ReadLimit_X);
	thomas_forward(d_fw_stm[4], c2_fw_stm[4], d2_fw_stm[4], M, B_X);
	thomas_backward(c2_fw_stm[4], d2_fw_stm[4], u_stm_2[0], M, B_X, ReadLimit_X);
//	TDMA_comp(d_stm_2[3], u_stm_2[0], M, N, B, 0);
	stream_8x8transpose(u_stm_2[0], u_stm_2[1], M, N, B, 0);
	undo_interleaved_row_block8(u_stm_2[1], u_stm_2[2], M, N, B, 0);

	interleaved_row_col(u_stm_2[2], d_stm_2[4], M, N, B, 1);
	thomas_interleave(d_stm_2[4], d_fw_stm[5], N, B_Y, ReadLimit_Y);
	thomas_forward(d_fw_stm[5], c2_fw_stm[5], d2_fw_stm[5], N, B_Y);
	thomas_backward(c2_fw_stm[5], d2_fw_stm[5], u_stm_2[3], N, B_Y, ReadLimit_Y);
//	TDMA_comp(d_stm_2[4], u_stm_2[3], M, N, B, 1);
	interleaved_col_row(u_stm_2[3], u_stm_2[4], M, N, B, 1);

	write_u(acc2, acc_stm[5], M, N, B);
	write_u(u, u_stm_2[4], M, N, B);
